...
class Delete extends FolderCommand {
	protected function configure() {
		$this
			->setName('mergeodf:delete')
			->setDescription('Delete mergeodf')
	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$question = new ConfirmationQuestion('Are you sure you want to delete the mergeodf ' . $folder['mount_point'] . ' and all files within, this cannot be undone (y/N).', false);
